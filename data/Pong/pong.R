...
dqn = dopamine %>% filter(Agent=="DQN") %>% filter(Iteration < 40)
...
bdqn = read.csv('run-bdqn_pong_1-tag-Eval_AverageReturns.csv')
bdqn$Wall.time = NULL
...
ggsave("../../Thesis/fig/BDQNPong.png", width=126*2, height=126*2, units="mm", dpi=150)
