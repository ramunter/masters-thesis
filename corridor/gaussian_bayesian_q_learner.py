...
Parameters = namedtuple('Parameters', ['state_mean', 'state_sd', 'action_mean', 'action_sd'])


def gaussian_q_learner(env, episodes=10000):
...
def sample_target_gaussian_q_learner(env, episodes=10000):
...
class UBECritic():
    ...
    def print_q_values(self, num_states):
        ...
        for state in range(0,num_states):
            print(
                  round(self.mean_q_value(state, 0), 2),
                  end=' ')
        print()
        ...
        for state in range(0,num_states):
            print(
                  round(self.mean_q_value(state, 1), 2),
                  end=' ')
        print()
