...
\begin{figure}[H]
    \centering
    \subfloat[DQN]{
        \includegraphics[width=0.5\textwidth]{100iterations01.png}
    }
    \subfloat[UBE]{
        \includegraphics[width=0.5\textwidth]{100iterations1.png}
    }
    \\
    \subfloat[Test]{
        \includegraphics[width=0.5\textwidth]{100iterations10.png}
    }
...
Based on these results focus is placed on the unknown noise model with sampled targets.
