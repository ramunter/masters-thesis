...
In this evaluation phase the model and network are not trained. The DQN agent acts greedly with respect to the DQN output, in other words with $\varepsilon=0$. The BNIG DQN acts greedily with respect to it's MAP estimate. This means it acts based on the mean $\beta$ values and no noise.
